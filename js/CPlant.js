            ...
            oSym.addTask(420,
                function(b) {
                    var e = $P[b],
                        ...
                        d,
                        f;
                    e && (d = e.R, f = e.C, e.jinyin?delete oGd.$Tombstones[c = d + "_" + f]:oGd.$Tombstones[c = d + "_" + f]=2, e.Die(), !e.jinyin?ClearChild($("dTombstones" + c)):$("dTombstones" + c).style.transform="rotateY(180deg)",
        ...
        getHurt: function(d, b, a) {
            ...
            switch (b) {
                ...
                case 0:
                    c.num+=1;
                    !c.Sleep && (d.bedevil(d),
        c.jinyin&&(d.BulletEle = NewImg(0, "images/Plants/PB"+(c.num<2?"-1":"0")+"0.gif","left:" + (d.AttackedLX - 40) + "px;top:" + (d.pixelTop + 30) + "px;visibility:hidden;z-index:" + (d.zIndex + 2)), 
