            ...
            oSym.addTask(420,
                function(b) {
                    var e = $P[b],
                        ...
                        d,
                        f;
                    e && (d = e.R, f = e.C, e.jinyin?delete oGd.$Tombstones[c = d + "_" + f]:oGd.$Tombstones[c = d + "_" + f]=2, e.Die(), !e.jinyin?ClearChild($("dTombstones" + c)):$("dTombstones" + c).style.transform="rorateY(180deg)",
