oS.Init({
  PName:[oPeashooter,oSunFlower,oCherryBomb,oWallNut,oPotatoMine,oSnowPea,oChomper,oRepeater,oPuffShroom,oSunShroom,oFumeShroom,oGraveBuster,oHypnoShroom,oScaredyShroom,oIceShroom,oDoomShroom,oLilyPad,oSquash,oThreepeater,oTangleKelp,oJalapeno,oSpikeweed],
  ZName:[oZombie,oZombie2,oZombie3,oDuckyTubeZombie1,oDuckyTubeZombie2,oDuckyTubeZombie3,oConeheadZombie,oFootballZombie,oBucketheadZombie,oZomboni,oSnorkelZombie],
  PicArr:function(){
  ...
  FlagToSumNum:{
    ...
    a2:[1,2,3,10,8,10,12,30,21,16,18,75]
  },
  FlagToMonitor:{
    9:[ShowLargeWave,0],
    19:[ShowLargeWave,0],
  ...
  FlagToEnd:function(){
    NewImg("imgSF","images/Card/Plants/Torchwood.png","left:627px;top:325px;clip:rect(auto,auto,60px,auto)",EDAll,{
      onclick:function(){GetNewCard(this,oTorchwood,0)}
    });
