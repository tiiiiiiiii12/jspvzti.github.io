oS.Init({
	PName: [oCherryBomb],
	ZName: [oZombie,oBucketheadZombie, oFootballZombie, oJackinTheBoxZombie,oNewspaperZombie,oGargantuar,oGatlingPeaZombie,oSquashZombie,oLadderZombie,oFlagZombie,oImp,oPoleVaultingZombie,oPeaZombie],
	...
	LevelName: "罐子生产者", LvlEName: "VaseKiller4", 
	...
	VaseArP : {
		GreenNum: 0, Left: 4, Right: 9, 
		ZombieP: [0, 0, 0, 1, 1, 2, 2, 3, 4, 4, 5, 6, 6, 7, 7, 8,8,9,10,10,11,11,3,12,12,6,7,12,11,2], 
		PlantP: [], 
		SunP: [] 
	}
}, 0, {
