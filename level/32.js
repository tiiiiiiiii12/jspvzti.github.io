oS.Init({
  ...
  ZName:[oZombie,oZombie2,oDuckyTubeZombie1,oConeheadZombie,oFootballZombie,oJackinTheBoxZombie,oNewspaperZombie,oImp,oGatlingPeaZombie],
  PicArr:function(){
  ...
  FlagToEnd:function(){
    NewImg("imgSF","images/Card/Plants/Cactus.png","left:627px;top:325px;clip:rect(auto,auto,60px,auto)",EDAll,{
      onclick:function(){GetNewCard(this,oCactus,33)}
    });
