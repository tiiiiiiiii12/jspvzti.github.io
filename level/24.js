oS.Init({
  ...
  ZName:[oZombie,oZombie2,oZombie3,oDuckyTubeZombie1,oDuckyTubeZombie2,oDuckyTubeZombie3,oConeheadZombie,oNewspaperZombie,oBucketheadZombie,oPoleVaultingZombie,oSnorkelZombie,oDancingZombie],
  PicArr:function(){
  ...
  FlagToSumNum:{
    ...
    a2:[1,2,3,10,4,7,8,40,14,16,18,50]
  },
  FlagToMonitor:{
    9:[ShowLargeWave,0],
    19:[ShowLargeWave,0],
  ...
  FlagToEnd:function(){
    NewImg("imgSF","images/interface/trophy.png","left:417px;top:233px;z-index:255",EDAll,{
      onclick:function(){SelectModal(25)}
    })}
});
